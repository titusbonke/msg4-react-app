...
function ManageGroup() {
    ...
    return (<>
        ...
        <TableLayout>
            ...
            <TableRow>
            <TableData iconClass={"fas fa-tags"} textAlign="center" />
            <TableData  text={"Test"}/>
            <TableData  text={"Test"}/>
            <TableData iconClass={"fas fa-edit"} textAlign="center"  isPopUp url="Master/AddGroup" popUpHeight={window.screen.availHeight} />
